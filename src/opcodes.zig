...
pub fn opcode06(cpu: *Cpu) void {
    ...
    cpu.pc = @addWithOverflow(cpu.pc, 2)[0];
}
...
pub fn opcode1B(cpu: *Cpu) void {
    cpu.registers.setDE(@subWithOverflow(cpu.registers.getDE(), 1)[0]);
    cpu.pc = @addWithOverflow(cpu.pc, 1)[0];
}
